 ...
 */
    ...
    (() => {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            ...
                            if (spollerTitle.classList.contains("menu-catalog__link_icon")) if (!spollerTitle.classList.contains("_spoller-active")) {
                                if (spollerTitle.classList.contains("one")) {
                                    spollerTitle.closest(".menu-catalog__item").classList.add("_mb-show_item");
                                    spollerTitle.closest(".menu-catalog").classList.add("_show");
                                    siblings(spollerTitle.closest(".menu-catalog__item")).forEach((el => {
                                        el.classList.add("hide");
                                    }));
                                }
                            } else if (spollerTitle.classList.contains("one")) {
                                spollerTitle.closest(".menu-catalog__item").classList.remove("_mb-show_item");
                                spollerTitle.closest(".menu-catalog").classList.remove("_show");
                                siblings(spollerTitle.closest(".menu-catalog__item")).forEach((el => {
        ...
        function tabs() {
            ...
            function initTabs(tabsBlock) {
                ...
                if (tabsContent.length) {
                    ...
                    tabsContent.forEach(((tabsContentItem, index) => {
                        if (document.querySelector(".help-tabs__navigation")) {
                            tabsTitles[index + 1].setAttribute("data-tabs-title", "");
            ...
            function setTabsStatus(tabsBlock, tabsTitleAll) {
                ...
                if (tabsContent.length > 0) {
                    ...
                    tabsContent.forEach(((tabsContentItem, index) => {
                        if (tabsTitles[index].classList.contains("_tab-active")) {
                            ...
                            if (tabsTitleAll) tabsContentItem.hidden = false;
                        }
                    }));
                }
            }
            function setTabsAction(e) {
                ...
                if (el.classList.contains("_all")) {
                    ...
                    setTabsStatus(tabsBlock, el.classList.contains("_all"));
                    e.preventDefault();
                }
                if (el.closest("[data-tabs-title]")) {
                    ...
                    if (!tabTitle.classList.contains("_tab-active") && !tabsBlock.querySelector("._slide")) {
                        ...
                        if (tabsBlock.querySelector("._all")) {
                            let tabActiveTitleAll = tabsBlock.querySelector("._all");
                            tabActiveTitleAll.classList.remove("_tab-active");
                        }
                        tabTitle.classList.add("_tab-active");
                        setTabsStatus(tabsBlock);
                    } else if (document.querySelector(".productCard-content__tabs") && document.documentElement.clientWidth < 767.99) if (tabTitle.classList.contains("_tab-active")) {
        ...
        if (window.innerWidth <= 767.98 && catalogTitle) document.querySelector(".breadcrumb").after(catalogTitle);
        let productCard = document.querySelector(".productCard__flex");
        if (window.innerWidth <= 991.98 && productCard) document.querySelector(".productCard-info__op").after(productCard);
        let productCardImages = document.querySelector(".productCard-images__info");
        if (window.innerWidth <= 991.98 && productCardImages) document.querySelector(".productCard__flex").after(productCardImages);
        let map;
        function initMap() {
        ...
        if (document.querySelector("#map")) window.initMap = initMap;
        if (document.querySelector("._show-form")) {
            let btnfrom = document.querySelector("._show-form"), formThank = document.querySelector(".contacts-form__thanks"), contactForm = document.querySelector(".contacts-form .form");
            btnfrom.addEventListener("click", (function(e) {
                formThank.classList.remove("_show");
                contactForm.reset();
            }));
        }
        if (document.querySelector(".checkbox-lang")) {
            function checkFluency() {
                var checkbox = document.querySelectorAll(".checkbox-lang");
                for (let i = 0; i < checkbox.length; i++) {
                    const el = checkbox[i];
                    let en = el.dataset.en, es = el.dataset.es;
                    el.addEventListener("click", (function(e) {
                        if (true != el.checked) location.href = en; else location.href = es;
                    }));
                }
            }
            checkFluency();
        }
        if (document.querySelector("._popup__content")) document.querySelector("._popup__content").addEventListener("mouseout", (function() {
            document.querySelector("._popup__content").classList.remove("_show");
        }));
        class Popup {
            constructor(options) {
                let config = {
            ...
            eventsPopup() {
                document.addEventListener("click", function(e) {
                    ...
                    if (buttonOpen) if (e.target.classList.contains("_active")) {
                        this.close();
                        ...
                        if ("error" !== this._dataValue) {
                            ...
                            document.querySelector("._popup__content").classList.add("_show");
                            return;
        ...
        function formFieldsInit(options = {
            ...
            if (options.viewPass) document.addEventListener("click", (function(e) {
                ...
                if (targetElement.closest('[class*="__viewpass"]')) {
                    ...
                    targetElement.closest(".form__input").querySelector("input").setAttribute("type", inputType);
        ...
        class SelectConstructor {
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    console.log(document.querySelectorAll(".select-js"));
            ...
            getSelectElement(selectItem, className) {
                return {
                    originalSelect: selectItem.querySelector(".select-js"),
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                var snapValues = [ document.getElementById("price-start"), document.getElementById("price-end") ];
        ...
        if (document.querySelector(".ben__swiper")) {
            ...
            function catalogSliderInit() {
                if (!catalogSlider) catalogSlider = new core(".ben__swiper", {
                    slidesPerView: 1,
        ...
        function initSliders() {
            ...
            if (document.querySelector(".productCard")) if (document.querySelector(".productCard--kit")) {
                new core(".productCard--kit ._productCard-slider", {
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
                ...
                const sliderThumbs = new core("._productCard-thumbs__slider", {
...
***************************************************************************** */
        ...
        menuInit();
        spollers();
        animateMarquee(document.querySelector("#marquee"), 2e4);
        tabs();
        showMore();
        if (document.querySelector("html").classList.contains("touch")) document.querySelector(".menu-catalog__btn").setAttribute("data-popup", "#menu_catalog");
        formFieldsInit({
            viewPass: true
        });
        formQuantity();
