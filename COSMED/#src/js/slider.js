...
if ($(window).width() < 1240 ) {
	$('.slider--js').parents('._section').find('.section-title').append(`<div class="blocks-arrow"></div>`)
	
	$('.slider--js').parents('._section').find('.blocks-arrow').append($('.slider--js .slick-arrow'))
