...
// OwlCarousel
$('.publication__slide').owlCarousel({
	margin: 15,
	nav: true,
	dots: false,
	responsive: {
...
if (window.innerWidth <= 768.99) {
	hideBlocks(document.querySelector('.program__row'), document.querySelector('._program-btn'), 'program__col', 2)
	hideBlocks(document.querySelector('.client__row'), document.querySelector('._client-btn'), 'client__col', 2)
	hideBlocks(document.querySelector('.teachers'), document.querySelector('._teachers-btn'), '_teachers-col', 2)
