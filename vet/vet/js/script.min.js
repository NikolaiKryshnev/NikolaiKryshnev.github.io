...
//!SLIDER
e(".ban-slider--js").slick({dots:!0,slidesToShow:1,arrows:!1,autoplay:!0,autoplaySpeed:3e3});let n=e(".header-bot"),i=e(".header-top__phone"),o=e(".header-top__right"),r=e(".burger");function s(){e(window).width()<=726?(n.append(i),n.append(r)):(i.prependTo(o),o.append(r))}e(window).resize((function(){s()})),e(document).ready((function(){s()}));let a=e(".js-tab-trigger"),l=e(".tab-content");function c(){if(e(window).width()<=726)for(let t=0;t<a.length;t++){const n=a[t];e(n).append(e(`.tab-content__item[data-tab='${t+1}']`))}else for(let t=0;t<a.length;t++)l.append(e(`.tab-content__item[data-tab='${t+1}']`))}function d(){let t=e(".accordeon-js .acc-body-js"),n=e(".accordeon-js .acc-head-js");e(window).width()<=1200?(t.not(e(this).parent().next()).slideUp(1e3).removeClass("active"),e(this).parent().next().slideToggle(1e3).toggleClass("active"),n.not(e(this).parent()).removeClass("active"),e(this).parent().toggleClass("active")):(t.not(e(this).next()).slideUp(1e3).removeClass("active"),e(this).next().slideToggle(1e3).toggleClass("active"),n.not(e(this)).removeClass("active"),e(this).toggleClass("active"))}function u(t,n,i){t.click((function(){t.toggleClass("active"),n.toggleClass("active");let o=e("header").height();n.hasClass("header-menu")?(console.log("yes"),n.css({top:o+"px"}),i.toggleClass("active")):i.toggleClass("active")})),e(".search-close--js").click((function(){t.removeClass("active"),n.removeClass("active"),i.removeClass("active"),e(".search-input--js").val("")})),i.on("click",(function(e){e.target==this&&(t.removeClass("active"),n.removeClass("active"),i.removeClass("active"))}))}var p,f,h;a.click((function(){var t=e(this).attr("data-tab"),n=e('.js-tab-content[data-tab="'+t+'"]');e(".js-tab-trigger.active").removeClass("active"),e(this).addClass("active"),e(".js-tab-content.active").removeClass("active"),n.addClass("active")})),c(),e(window).resize((function(){c()})),e(document).ready((function(){e(window).width()<=1200?e(".accordeon-js  .acc-head-js .sidebar-arrow").on("click",d):e(".accordeon-js  .acc-head-js").on("click",d)})),u(e(".burger--js"),e(".header-menu--js"),e(".main")),u(e(".search-btn--js"),e(".header-search--js"),e(".main")),p=e(".popupBtn-js"),f=e(".modal-overlay, .modal"),h=e(".close-js"),p.click((function(){f.addClass("active"),e(".wrapper").addClass("active")})),h.click((function(){f.removeClass("active")}))}(jQuery);