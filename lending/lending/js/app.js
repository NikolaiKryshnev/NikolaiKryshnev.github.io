...
function popup_open(item, video = '', elem) {
	...
	if (item === 'rw') {
		...
		curent_popup.querySelector('.popup__boximg').querySelector('img').setAttribute('src', `${url}.jpg`)
		curent_popup.querySelector('.popup__boximg').querySelector('source').setAttribute('srcset', `${url}.webp`)
...
function form_add_error(input) {
	...
	if (input_error_text && input_error_text != '') {
		input.parentElement.insertAdjacentHTML('beforeend', '<div class="form__error">' + '!' + '<div class="form__error_text">' + input_error_text + '</div>' + '</div>');
	}
}
